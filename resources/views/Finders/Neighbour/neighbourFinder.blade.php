                ...
                <table class="table table-borderless mt-2">
                    <tr>
                        <td class="col-md-5">
                            ...
                            <div class="px-2 py-1"><strong>Distance: </strong><input type="number" name="dist" required value="{{old('dist') ?? '50'}}"/></div>
                            <div class="px-2 py-1"><strong>Min Pop : </strong><input type="number" min=2 name="pop" required value="{{old('pop') ?? '2'}}"/></div>
