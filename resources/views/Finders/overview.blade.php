...
<!-- =============================================Finders Main Menu============================================ -->
    <div class="card float-md-left col-md-12 col-12 mb-5 p-0 shadow">
        ...
        <div class="card-text">
            ...
            <table class="table table-borderless col-md-10 col-10 mx-auto">
                ...
                <tr>
                    <td class="align-middle h6"><a href="{{route('findAlliance')}}" class="text-success"><strong>Alliance Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle h6"><a href="{{route('findInactive')}}" class="text-success"><strong>Inactive Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle h6"><a href="{{route('findNatar')}}" class="text-success"><strong>Natar Finder</strong></a></td>
                    <td class="font-italic">Displays the natar villages within the range of the input coordinates.</td>
                </tr>
                <tr>
                    <td class="align-middle h6"><a href="{{route('findNeighbour')}}" class="text-success"><strong>Neighbour Finder</strong></a></td>
