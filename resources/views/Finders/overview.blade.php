...
<!-- =============================================Finders Main Menu============================================ -->
    <div class="card float-md-left col-md-12 mt-1 p-0 shadow">
        ...
        <div class="card-text">
            <p class="col-md-9 mx-auto align-middle pt-2">Finders will help you with finding details on the server such as player, alliance, neighbours, or inactive players.</p>
            <table class="table table-borderless col-md-10 mx-auto">
                <tr>
                    <td class="align-middle"><a href="/finder/player" class="text-success"><strong>Player Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle"><a href="/finder/alliance" class="text-success"><strong>Alliance Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle"><a href="/finder/inactive" class="text-success"><strong>Inactive Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle"><a href="/finder/natar" class="text-success"><strong>Natar Finder</strong></a></td>
                    <td class="font-italic">Displays the natar villages within the range of the input coordinates.</td>
                </tr>
                <tr>
                    <td class="align-middle"><a href="/finder/neighbour" class="text-success"><strong>Neighbour Finder</strong></a></td>
