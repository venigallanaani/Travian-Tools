    ...
    <div class="card float-md-left col-md-12 col-12 mt-1 p-0 shadow">
        ...
        <div class="card-text">
            ...
            <table class="table table-borderless col-md-10 col-10 mx-auto">
                <tr>
                    <td class="align-middle"><a href="/finders/player" class="text-success"><strong>Player Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle"><a href="/finders/alliance" class="text-success"><strong>Alliance Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle"><a href="/finders/inactive" class="text-success"><strong>Inactive Finder</strong></a></td>
                ...
                <tr>
                    <td class="align-middle"><a href="/finders/natar" class="text-success"><strong>Natar Finder</strong></a></td>
                    <td class="font-italic">Displays the natar villages within the range of the input coordinates.</td>
                </tr>
                <tr>
                    <td class="align-middle"><a href="/finders/neighbour" class="text-success"><strong>Neighbour Finder</strong></a></td>
