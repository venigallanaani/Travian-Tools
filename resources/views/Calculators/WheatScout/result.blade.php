	...
	<div class="card float-md-left my-1 p-0 col-md-12 shadow mb-5">
        ...
        <div class="card-text mx-auto text-center mt-2">
        	<table class="table table-borderless mx-auto">
        		...
        		<tr>
        			<td class="py-1 px-5">Defense Upkeep - <img alt="" src="/images/x.gif" class="res upkeep"> <strong>{{number_format($result['DEFUP'])}}</strong></td>
        			<td class="py-1 px-5">Reinforcements Upkeep - <img alt="" src="/images/x.gif" class="res upkeep"> <strong>{{number_format($result['REINUP'])}}</strong></td>
        		</tr>
        		<tr>
        			<td colspan="2" class="py-1"><strong>Total Upkeep of units present in village - <img alt="" src="/images/x.gif" class="res upkeep"> {{number_format($result['DEFUP'] + $result['REINUP'])}}</strong></td>
        	...
        	@else
			<p><strong><h4><span class="text-danger">Troops Away</span></h4></strong></p>        			
