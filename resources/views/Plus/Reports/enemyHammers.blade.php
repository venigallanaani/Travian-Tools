...
@section('body')
		...
		<div class="card float-md-left col-md-10 p-0 shadow">
			<div class="card-header h5 py-2 bg-info text-white"><strong>Enemy Hammers Tracking</strong></div>
			<div class="card-text">
		<!-- ========================== Create CFD Options ============================== -->
				<div class="m-3">
        		...
        		<div class="card card-body m-3">
        			<table class="table text-center table-sm table-hover p-0 table-bordered">
        				<thead class="">
    						...
    						<tr class="text-info font-weight-bold h6">
    							...
    							<td class="px-1">Speed Artifact</td>    							
    				...
    				@foreach($hammers as $hammer)
    					<tr class="h6" id="{{$hammer['id']}}">
							...
							<td class="px-1">
								<select id="tsq" style="font-size:0.8em">
							...
							<td class="px-1">
								<select id="art" style="width:4em; font-size:0.8em">
