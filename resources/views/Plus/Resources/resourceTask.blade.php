                    ...
                    <form method="POST" action="/plus/resource/update">
                        ...
                        <table class="table col-md-10 table-borderless mx-auto text-left">
                            <tr>
                                ...
                                <td class="py-1 col-md-6"><strong>Resource Target:</strong> {{number_format($task['res_total'])}}</td>
                            </tr>
                            <tr>
                                <td class="py-1 col-md-6"><strong>Resource Sent: </strong><input type="number" min="0" name="res" required size='3'/></td>
                                <td class="py-1 col-md-6"><strong>Resource Collected:</strong> {{number_format($task['res_received'])}} ({{$task['res_percent']}}%)</td>
                            </tr>
                            <tr>
                                ...
                                <td class="py-1 col-md-6"><strong>Resources Remaining:</strong> {{number_format($task['res_remain'])}}</td>
                            </tr>
                            <tr>
                                ...
                                <td class="py-1 col-md-6 text-info"><strong>Your Contribution:</strong> {{number_format($player['resources']) ?? 0}}</td>
                            </tr>
                            <tr>
