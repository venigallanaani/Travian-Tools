        								...
        								<tr>
        									<td>
                    							...
                    							@if($incomings[0]['att_tribe']=='ROMAN')
                        							<option value="RR1" @if($tracks[0]['right'] =='RR1') selected @endif>Legionnaire Sword</option>
                        							<option value="RR2" @if($tracks[0]['right'] =='RR2') selected @endif>Praetorian Sword</option>
                        							<option value="RR3" @if($tracks[0]['right'] =='RR3') selected @endif>Imperian Sword</option>
                        							<option value="RR4" @if($tracks[0]['right'] =='RR4') selected @endif>Imperatoris Sword</option>
                        							<option value="RR5" @if($tracks[0]['right'] =='RR5') selected @endif>Caesaris Lance</option>
                    							@endif
                    							@if($incomings[0]['att_tribe']=='GUAL')
                        							<option value="RG1" @if($tracks[0]['right'] =='RG1') selected @endif>Phalanx Spear</option>
                        							<option value="RG2" @if($tracks[0]['right'] =='RG2') selected @endif>Swordsman Sword</option>
                        							<option value="RG3" @if($tracks[0]['right'] =='RG3') selected @endif>Theutates Bow</option>
                        							<option value="RG4" @if($tracks[0]['right'] =='RG4') selected @endif>Druidrider Staff</option>
                        							<option value="RG5" @if($tracks[0]['right'] =='RG5') selected @endif>Haeduan Lance</option>
                    							@endif
                    							@if($incomings[0]['att_tribe']=='TEUTON')
                        							<option value="RT1" @if($tracks[0]['right'] =='RT1') selected @endif>Clubswinger Club</option>
                        							<option value="RT2" @if($tracks[0]['right'] =='RT2') selected @endif>Spearman Spear</option>
                        							<option value="RT3" @if($tracks[0]['right'] =='RT3') selected @endif>Axeman Axe</option>
                        							<option value="RT4" @if($tracks[0]['right'] =='RT4') selected @endif>Paladin Hammer</option>
                        							<option value="RT5" @if($tracks[0]['right'] =='RT5') selected @endif>Teutonic Knight Sword</option>
                    							@endif
                    							@if($incomings[0]['att_tribe']=='EGYPTIAN')
                        							<option value="RE1" @if($tracks[0]['right'] =='RE1') selected @endif>Slave Militia Club</option>
                        							<option value="RE2" @if($tracks[0]['right'] =='RE2') selected @endif>Ash Warden Axe</option>
                        							<option value="RE3" @if($tracks[0]['right'] =='RE3') selected @endif>Warrior Khopesh</option>
                        							<option value="RE4" @if($tracks[0]['right'] =='RE4') selected @endif>Anhor Guard Spear</option>
                        							<option value="RE5" @if($tracks[0]['right'] =='RE5') selected @endif>resheph Chariot Bow</option>
                    							@endif
                    							@if($incomings[0]['att_tribe']=='HUN')
                        							<option value="RH1" @if($tracks[0]['right'] =='RH1') selected @endif>Mercenary Axe</option>
                        							<option value="RH2" @if($tracks[0]['right'] =='RH2') selected @endif>Bowman Bow</option>
                        							<option value="RH3" @if($tracks[0]['right'] =='RH3') selected @endif>Steppe Rider Sword</option>
                        							<option value="RH4" @if($tracks[0]['right'] =='RH4') selected @endif>Marksman Bow</option>
                        							<option value="RH5" @if($tracks[0]['right'] =='RH5') selected @endif>Marauder Sword</option>
                    							@endif
                        						</select>
                        						<select name="left" class="small">
                        							<option value="">--Select Left hand--</option>
                        							<option value="l11" @if($tracks[0]['left'] =='l11') selected @endif>Map</option>
                        							<option value="l12" @if($tracks[0]['left'] =='l12') selected @endif>Standard</option>
                        							<option value="l13" @if($tracks[0]['left'] =='l13') selected @endif>Sheild</option>
                        							<option value="l14" @if($tracks[0]['left'] =='l14') selected @endif>Pennant</option>
                        							<option value="l15" @if($tracks[0]['left'] =='l15') selected @endif>Bag</option>
                        							<option value="l16" @if($tracks[0]['left'] =='l16') selected @endif>Natarian Horn</option>
                        						</select>
        									</td>
        									<td rowspan="3">
        								...
        								<tr>
        									<td>	
        										<select name="helm" class="small">
                        							...
                        							<option class="p-0 m-0" value="h11" @if($tracks[0]['helm'] =='h11') selected @endif>Helmet of Awareness</option>
                        							<option class="p-0 m-0" value="h12" @if($tracks[0]['helm'] =='h12') selected @endif>Helmet of Enlightenment</option>
                        							<option class="p-0 m-0" value="h13" @if($tracks[0]['helm'] =='h13') selected @endif>Helmet of Wisdom</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="h21" @if($tracks[0]['helm'] =='h21') selected @endif>Helmet of Regeneration</option>
                        							<option class="p-0 m-0" value="h22" @if($tracks[0]['helm'] =='h22') selected @endif>Helmet of Healthiness</option>
                        							<option class="p-0 m-0" value="h23" @if($tracks[0]['helm'] =='h23') selected @endif>Helmet of Healing</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="h31" @if($tracks[0]['helm'] =='h31') selected @endif>Helmet of Gladiator</option>
                        							<option class="p-0 m-0" value="h32" @if($tracks[0]['helm'] =='h32') selected @endif>Helmet of Tribune</option>
                        							<option class="p-0 m-0" value="h33" @if($tracks[0]['helm'] =='h33') selected @endif>Helmet of Consul</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="h41" @if($tracks[0]['helm'] =='h41') selected @endif>Helmet of Mercenary</option>
                        							<option class="p-0 m-0" value="h42" @if($tracks[0]['helm'] =='h42') selected @endif>Helmet of Warrior</option>
                        							<option class="p-0 m-0" value="h43" @if($tracks[0]['helm'] =='h43') selected @endif>Helmet of Archon</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="h51" @if($tracks[0]['helm'] =='h51') selected @endif>Helmet of Horseman</option>
                        							<option class="p-0 m-0" value="h52" @if($tracks[0]['helm'] =='h52') selected @endif>Helmet of Cavalry</option>
                        							<option class="p-0 m-0" value="h53" @if($tracks[0]['helm'] =='h53') selected @endif>Helmet of Heavy cavalry</option>
                    							</select>
                    							<select name="chest" class="small">
                    								<option value="">--Select Chest--</option>
                        							<option class="p-0 m-0" value="c11" @if($tracks[0]['chest'] =='c11') selected @endif>Light armour of Regeneration</option>
                        							<option class="p-0 m-0" value="c12" @if($tracks[0]['chest'] =='c12') selected @endif>Armour of Regeneration</option>
                        							<option class="p-0 m-0" value="c13" @if($tracks[0]['chest'] =='c13') selected @endif>Heavy armour of Regeneration</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="c21" @if($tracks[0]['chest'] =='c21') selected @endif>Light Breastplate</option>
                        							<option class="p-0 m-0" value="c22" @if($tracks[0]['chest'] =='c23') selected @endif>Breastplate</option>
                        							<option class="p-0 m-0" value="c23" @if($tracks[0]['chest'] =='c23') selected @endif>Heavy Breastplate</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="c31" @if($tracks[0]['chest'] =='c31') selected @endif>Light scale armour</option>
                        							<option class="p-0 m-0" value="c32" @if($tracks[0]['chest'] =='c32') selected @endif>Scale armour</option>
                        							<option class="p-0 m-0" value="c33" @if($tracks[0]['chest'] =='c33') selected @endif>Heavy scale armour</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="c41" @if($tracks[0]['chest'] =='c41') selected @endif>Light segmented armour</option>
                        							<option class="p-0 m-0" value="c42" @if($tracks[0]['chest'] =='c42') selected @endif>Segmented armour</option>
                        							<option class="p-0 m-0" value="c43" @if($tracks[0]['chest'] =='c43') selected @endif>Heavy segmented armour</option>
                    							</select>
        									</td>
        								</tr>
        								<tr>
        									<td>        										
        										<select	name="boot" class="small">
                        							...
                        							<option class="p-0 m-0" value="f11" @if($tracks[0]['boots'] =='f11') selected @endif>Boots of Regeneration</option>
                        							<option class="p-0 m-0" value="f12" @if($tracks[0]['boots'] =='f12') selected @endif>Boots of Healthiness</option>
                        							<option class="p-0 m-0" value="f13" @if($tracks[0]['boots'] =='f13') selected @endif>Boots of Healing</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="f21" @if($tracks[0]['boots'] =='f21') selected @endif>Small spurs</option>
                        							<option class="p-0 m-0" value="f22" @if($tracks[0]['boots'] =='f22') selected @endif>Small spurs</option>
                        							<option class="p-0 m-0" value="f23" @if($tracks[0]['boots'] =='f23') selected @endif>Nasty spurs</option>
                        							<option class="p-0 m-0" disabled>----------</option>
                        							<option class="p-0 m-0" value="f31" @if($tracks[0]['boots'] =='f31') selected @endif>Boots of the Mercenary</option>
                        							<option class="p-0 m-0" value="f32" @if($tracks[0]['boots'] =='f32') selected @endif>Boots of the Warrior</option>
                        							<option class="p-0 m-0" value="f33" @if($tracks[0]['boots'] =='f33') selected @endif>Boots of the Archon</option>
                        						</select>
        									</td>
        								</tr>
        								<tr>
