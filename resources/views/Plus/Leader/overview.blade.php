...
<!-- ==================================== Main Content of the Plus Menu ================================= -->
		<div class="card float-md-left col-md-9 mt-1 p-0 shadow">
			<div class="card-header h4 py-2 bg-info text-white"><strong>Overview</strong></div>
			<div class="card-text">			
				...
				<div class="col-md-11 mx-auto py-2">
        			<div class="card shadow col-md-8 p-0 mx-auto">
            			...
            			<div class="card-text">
            				...
            				<form id="form" action="/leader/overview/message" method="POST" onsubmit="return getContent()" class="text-center pb-3">
            					{{ csrf_field() }}
        ...
        <!-- =========================== Add to group link ================================ -->
        		<div class="col-md-11 mx-auto py-3 mb-5">
