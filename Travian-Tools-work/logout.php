...
session_start();
$_SESSION['LOGIN_HEADER'] = '<h3 class="header"><span style="color:white;">Logged Out</span></h3>';
$_SESSION['LOGIN_MESSAGE']='<p><span style="font-size:1.5em;">You are logged out!!</span></p>';
?>
<?php 
